...
export const Stories = () => {
    ...
    return <>
        <div className={styles.storiesContainer}>
            <Carousel itemsToShow={5} renderArrow={renderArrow} pagination={false} outerSpacing={-8} itemPadding={[0]} >
...
const left = <i className={"fa fa-chevron-circle-left"} style={{ color: "#7a757521", marginTop: "32px", cursor: "pointer", fontSize: "25px" }}></i>
const right = <i className={"fa fa-chevron-circle-right"} style={{ color: "#7a757521", marginTop: "32px", cursor: "pointer", fontSize: "25px" }}></i>
