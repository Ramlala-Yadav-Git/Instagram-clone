...
const left = <i className={"fa fa-chevron-circle-left"} style={{ color: "#7a757521", marginTop: "24px", cursor: "pointer", fontSize: "25px" }}></i>
const right = <i className={"fa fa-chevron-circle-right"} style={{ color: "#7a757521", marginTop: "24px", cursor: "pointer", fontSize: "25px" }}></i>
